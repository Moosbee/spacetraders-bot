...
export type GetAllTradeRoutesQuery = { __typename?: 'QueryRoot', tradeRoutes: { __typename?: 'TradeRoutePage', items: Array<{ __typename?: 'TradeRoute', id: number, createdAt: string, symbol: TradeSymbol, shipSymbol: string, PurchaseWaypointSymbol: string, SellWaypointSymbol: string, status: ShipmentStatus, tradeMode: TradeMode, tradeVolume: number, reservedFund?: number | null, estimatedFuel?: number | null, marketTransactionSummary: { __typename?: 'TransactionSummary', expenses?: number | null, income?: number | null }, purchaseMarketTradeGood?: { __typename?: 'MarketTradeGood', tradeVolume: number, supply: SupplyLevel, activity?: ActivityLevel | null, purchasePrice: number, sellPrice: number } | null, sellMarketTradeGood?: { __typename?: 'MarketTradeGood', tradeVolume: number, supply: SupplyLevel, activity?: ActivityLevel | null, purchasePrice: number, sellPrice: number } | null }> } };
