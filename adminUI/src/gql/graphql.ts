...
export type DbMarketTrade = {
  __typename?: 'DBMarketTrade';
  createdAt: Scalars['DateTime']['output'];
  symbol: TradeSymbol;
...
export type DbMarketTradeGood = {
  __typename?: 'DBMarketTradeGood';
...
export type TradeRouteCandidate = {
  ...
  purchase: DbMarketTrade;
  purchaseGood?: Maybe<DbMarketTradeGood>;
  purchaseMarketTradeGood?: Maybe<MarketTradeGood>;
  purchaseWaypoint?: Maybe<Waypoint>;
  sell: DbMarketTrade;
  sellGood?: Maybe<DbMarketTradeGood>;
  sellMarketTradeGood?: Maybe<MarketTradeGood>;
  sellWaypoint?: Maybe<Waypoint>;
  symbol: TradeSymbol;
