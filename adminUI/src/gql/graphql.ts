...
export type GetWaypointQuery = { __typename?: 'QueryRoot', waypoint: { __typename?: 'Waypoint', symbol: string, waypointType: WaypointType, traits: Array<WaypointTraitSymbol>, faction?: string | null, chartedBy?: string | null, chartedOn?: string | null, unstableSince?: string | null, systemSymbol: string, x: number, y: number, lastScrap?: string | null, nextScrap?: string | null, orbitals: Array<string>, orbits?: string | null, isUnderConstruction: boolean, hasMarketplace: boolean, hasShipyard: boolean, modifiers: Array<WaypointModifierSymbol>, jumpGateConnections: { __typename?: 'JumpGateConnectionPage', items: Array<{ __typename?: 'JumpGateConnection', id: number, from: string, to: string }> } } };
