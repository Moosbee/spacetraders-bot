...
export type GetAllSystemsQuery = { __typename?: 'QueryRoot', systems: Array<{ __typename?: 'System', symbol: string, constellation?: string | null, sectorSymbol: string, systemType: SystemType, x: number, y: number, populationDisabled: boolean, ships: Array<{ __typename?: 'Ship', symbol: string }> }> };
