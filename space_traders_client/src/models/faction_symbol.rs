...
pub enum FactionSymbol {
    ...
    #[strum(serialize = "GALACTIC")]
    Galactic,
    #[serde(rename = "QUANTUM")]
    #[strum(serialize = "QUANTUM")]
    Quantum,
    #[serde(rename = "DOMINION")]
    #[strum(serialize = "DOMINION")]
    Dominion,
    #[serde(rename = "ASTRO")]
    #[strum(serialize = "ASTRO")]
    Astro,
    #[serde(rename = "CORSAIRS")]
    #[strum(serialize = "CORSAIRS")]
    Corsairs,
    #[serde(rename = "OBSIDIAN")]
    #[strum(serialize = "OBSIDIAN")]
    Obsidian,
    #[serde(rename = "AEGIS")]
    #[strum(serialize = "AEGIS")]
    Aegis,
    #[serde(rename = "UNITED")]
    #[strum(serialize = "UNITED")]
    United,
    #[serde(rename = "SOLITARY")]
    #[strum(serialize = "SOLITARY")]
    Solitary,
    #[serde(rename = "COBALT")]
    #[strum(serialize = "COBALT")]
    Cobalt,
    #[serde(rename = "OMEGA")]
    #[strum(serialize = "OMEGA")]
    Omega,
    #[serde(rename = "ECHO")]
    #[strum(serialize = "ECHO")]
    Echo,
    #[serde(rename = "LORDS")]
    #[strum(serialize = "LORDS")]
    Lords,
    #[serde(rename = "CULT")]
    #[strum(serialize = "CULT")]
    Cult,
    #[serde(rename = "ANCIENTS")]
    #[strum(serialize = "ANCIENTS")]
    Ancients,
    #[serde(rename = "SHADOW")]
    #[strum(serialize = "SHADOW")]
    Shadow,
    #[serde(rename = "ETHEREAL")]
    #[strum(serialize = "ETHEREAL")]
    Ethereal,
}
